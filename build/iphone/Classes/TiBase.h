...
// in simulator we redefine to format for CoffeCup Developer console
...
{\
	NSString * exceptionName = [@"org.coffecup." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.coffecup";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UICoffeCupNativeItemNone = -1, 
	UICoffeCupNativeItemSpinner = -2,
	UICoffeCupNativeItemProgressBar = -3,
	
	UICoffeCupNativeItemSlider = -4,
	UICoffeCupNativeItemSwitch = -5,
	UICoffeCupNativeItemMultiButton = -6,
	UICoffeCupNativeItemSegmented = -7,
	
	UICoffeCupNativeItemTextView = -8,
	UICoffeCupNativeItemTextField = -9,
	UICoffeCupNativeItemSearchBar = -10,
	
	UICoffeCupNativeItemPicker = -11,
	UICoffeCupNativeItemDatePicker = -12,
	
	UICoffeCupNativeItemInfoLight = -13,
	UICoffeCupNativeItemInfoDark = -14,
	
	UICoffeCupNativeItemDisclosure = -15,
	
	UICoffeCupNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all CoffeCup instances of
