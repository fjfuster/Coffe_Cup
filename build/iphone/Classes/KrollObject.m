 ...
 * Copyright (c) 2009-2011 by CoffeCup, Inc. All Rights Reserved.
...
//@interface CoffeCupObject : NSObject
//@end

@interface CoffeCupObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[CoffeCupObject class]])
		{
			for (NSString *key in [[(CoffeCupObject*)o modules] allKeys])
			{
