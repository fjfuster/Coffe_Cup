...
static NSString * const kCoffeCupJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_coffecupInjection
{
	...
	[html appendString:kCoffeCupJavascript];
...
{
	// attempt to make well-formed HTML and inject in our CoffeCup bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _coffecupInjection]];
